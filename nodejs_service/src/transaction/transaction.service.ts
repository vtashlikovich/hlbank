...
export class TransactionService {
    ...
    constructor(
        ...
        this.mqConsumer = configService.get<string>('MQ_CONSUMER') == 'true';
    }
    ...
    async create(
        ...
        try {
            ...
            if (
                ...
                if (process.env.LOCK_TIMEOUT)
                    await this.sequelizeInstance.query('SET LOCAL lock_timeout = \'' + process.env.LOCK_TIMEOUT + '\'', {
                        transaction
                    });
                ...
                const account: Account = 
                        process.env.MQ_CONSUMER == 'true'?
                            await this.accountService.findNoLock(transaction, createTransactionDto.account_uid)
                            :await this.accountService.findOneAndLock(transaction, createTransactionDto.account_uid);
